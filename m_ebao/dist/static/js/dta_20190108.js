...
(function () {
    ...
    function _send(args, callback) {
            ...
            iframe.onload = function () {
                ...
                window.addEventListener("message", function (e) {
                    if (e.origin === host && e.data.idHost === originStr) {
                        ...
                        args += '&__QiSd=' + localStorage.__QiSd + '&timestamp=' + new Date().toISOString();
        ...
        (function () { // 打点失败，对应4个地方修改
            ReSendDs = window.ReSendDs || (window.ReSendDs = []);
            var s = document.createElement('script');
            s.type = 'text/javascript';
            s.async = true;
            s.crossorigin = 'anonymous';
            s.src = 'https://fe.tf.qschou.com/identity/reSendDs.js';
